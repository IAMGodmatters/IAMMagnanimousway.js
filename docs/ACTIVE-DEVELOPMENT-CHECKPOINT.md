...
- [x] Fonus confirmed receipt of the reseller inquiry/form, Ursula supplied the direct commercial contact `zhac@fonusmobile.com`, and the full no-spend reseller/global-mobile inquiry was sent there. Await agreement/rate/provisioning/compliance terms; no spend or activation was performed.
