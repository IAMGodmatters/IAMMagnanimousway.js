...
- [x] Received Gigs' handoff to its official business-email-only sales form and 1GLOBAL case `02547094`; preserved both live external onboarding references without opening duplicate cases or inventing contact identity fields.
