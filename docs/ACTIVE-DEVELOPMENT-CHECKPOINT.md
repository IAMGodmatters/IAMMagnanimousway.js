...
- The strict public verification workflow can now accept optional relay ICE configuration so a future relay deployment can prove real two-way browser media instead of being treated as live from source configuration alone. No TURN service has been provisioned or marked production-live.
