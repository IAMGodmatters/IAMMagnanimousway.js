...
export const TRAVEL_SUPPLIER_ONBOARDING=Object.freeze([
 ...
 {id:'ratehawk',priority:1,fit:'hotel-fast-launch',path:'direct registration → free API key → certification',action:'Register with API Integration purpose, obtain free API key, then complete certification.',url:'https://www.ratehawk.com/journey/api/',startup_path:'Official flow advertises free API key and certification.',initial:{status:'not_started',channel:'web',destination:'RateHawk API registration',outcome:''}},
 ...
 {id:'travelgate',priority:2,fit:'hotel-aggregation',path:'Hotel-X buyer connection',action:'Apply as buyer and connect approved seller inventory through Hotel-X.',url:'https://docs.travelgate.com/docs/apis/for-buyers/hotel-x-pull-buyers-api/quickstart/',startup_path:'Best after at least one seller relationship is ready.',initial:{status:'not_started'}},
