...
export const MAGNANIMOUS_EXECUTION_SURFACES=Object.freeze({
 ...
 'magnanimous-scheduler':{mode:'native',route:'/api/magnanimous/cloud/resources',module:'worker/src/magnanimous-cloud-provider-core.js',proof:'Magnanimous Cloud owns schedule desired state through the secured owner control API; standalone execution is provided by magnanimous-runtime/src/server.mjs scheduler/system-cron compatibility.'},
 'magnanimous-object-storage':{mode:'native',route:'/api/magnanimous/cloud/resources',module:'worker/src/magnanimous-cloud-provider-core.js',proof:'Magnanimous Cloud owns object-bucket desired state through the secured owner control API; first-party persistence is implemented by magnanimous-runtime/src/object-store.mjs.'},
 'magnanimous-backup-restore':{mode:'native',route:'/api/magnanimous/cloud/resources',module:'worker/src/magnanimous-cloud-provider-core.js',proof:'Magnanimous Cloud owns backup-policy desired state through the secured owner control API; standalone backup and restore execution is implemented by Magnanimous runtime scripts.'},
