...
export const MAGNANIMOUS_EXECUTION_SURFACES=Object.freeze({
 ...
 'magnanimous-scheduler':{mode:'native',route:'/__magnanimous_runtime/capabilities',module:'magnanimous-runtime/src/server.mjs',proof:'Standalone Magnanimous owns scheduled execution through its native scheduler/system-cron compatibility path.'},
 'magnanimous-object-storage':{mode:'native',route:'/__magnanimous_runtime/capabilities',module:'magnanimous-runtime/src/object-store.mjs',proof:'Magnanimous Object Store provides first-party persistent object storage without requiring provider buckets.'},
 'magnanimous-backup-restore':{mode:'native',route:'/__magnanimous_runtime/capabilities',module:'magnanimous-runtime/scripts/backup-runtime.mjs',proof:'Magnanimous owns backup, restore and migration verification tooling for standalone runtime state.'},
 ...
 'magnanimous-template-catalog':{mode:'native',route:'/api/magnanimous/cloud/resources',module:'magnanimous-runtime/src/cloud-control.mjs',proof:'Magnanimous Cloud can represent reusable provider-neutral multi-resource templates and desired state.'},
 ...
 'magnanimous-deployment-operator':{mode:'hybrid',route:'/api/magnanimous/dev-agent/workflows',module:'worker/src/magnanimous-dev-agent.js',proof:'Magnanimous owns deployment planning, staged actions and verification; Railway or another hosting target remains a replaceable external execution rail.'},
