...
const AGENTS=[
 ...
 ['procura','Procura','Procurement & Supplier Network','Supplier onboarding, sourcing events, RFQs, purchase orders, cXML/EDI, enterprise procurement networks and procure-to-pay workflows.','business'],
 ['freight','Freight','B2B Logistics Strategist','Parcel, freight, 3PL, warehousing, landed cost, trade documents, carrier APIs and shipment exception planning.','business'],
 ...
 ['traveldeal','TravelDeal','Travel Deal & Distribution Strategist','Lowest-verified-price routing, supplier comparison, source margin, sub-agent markup, wholesale distribution APIs, conversion, supplier yield and deal-proof strategy.','business'],
