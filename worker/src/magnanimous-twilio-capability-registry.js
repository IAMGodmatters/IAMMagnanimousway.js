...
export const MAGNANIMOUS_TWILIO_CAPABILITIES = Object.freeze([
  ...
  {id:'conversation-relay',domain:'ai_voice',capability:'speech_and_voice_ai_bridge',provider_feature:'Conversation Relay',actions:['speech_recognition','text_to_speech','voice_synthesis','websocket_agent_bridge']},
  ...
  {id:'conversation-memory',domain:'engagement',capability:'persistent_conversation_memory',provider_feature:'Conversation Memory',actions:['memory_extraction','cross_session_context','agent_context']},
  {id:'conversation-orchestrator',domain:'engagement',capability:'continuous_conversation_orchestration',provider_feature:'Conversation Orchestrator',actions:['cross_channel_continuity','routing','handoff']},
  {id:'conversation-intelligence',domain:'ai_analytics',capability:'conversation_transcription_and_analysis',provider_feature:'Conversation Intelligence',actions:['transcription','analysis','language_intelligence','automation_signals']},
  ...
  {id:'monitor',domain:'observability',capability:'provider_monitoring_and_audit',provider_feature:'Monitor / Workbench',actions:['alerts','alarms','debugger','resource_events','error_webhooks','audit_events']},
...
export const MAGNANIMOUS_TWILIO_DEVELOPER_KNOWLEDGE = Object.freeze([
  ...
  {id:'workbench',kind:'operations',capability:'debugger_alarms_and_quick_actions'},
  {id:'monitor-api',kind:'operations',capability:'alerts_alarms_and_resource_event_audit'},
