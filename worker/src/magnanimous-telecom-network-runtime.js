...
const MOBILE_PARTNERS=[
 ...
 {key:'1global',name:'1GLOBAL',status:'case_followed_up',channel:'email',destination:'business.help@1global.com',case_reference:'02547094',evidence_reference:'gmail:1a0db5066b33f92d;gmail:1a0dbc4f2e590b07;gmail:1a0dbc53906621d2;gmail:1a0dbcee2745d3d6',sandbox_reference:'https://docs.connect-api.1global.com/overview/getstarted/',notes:'1GLOBAL sent an automated case-updated notice without the requested commercial/technical evidence. Magnanimous replied again on case 02547094 requesting routing to a named Connect / Embedded Telco commercial/onboarding owner and the outstanding agreement, Philippines, sandbox, pricing and real-trial-eSIM evidence.',next_action:'Keep case 02547094 open and await a substantive Connect / Embedded Telco response with platform credentials/sandbox terms, commercial agreement, Philippines coverage/compliance, pricing, real trial eSIM path and independent backup details.'},
