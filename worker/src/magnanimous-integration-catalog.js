...
export const INTEGRATION_CATALOG = [
  ...
  {id:'google',name:'Google / Gmail connector',category:'email',capabilities:['read_mail','send_mail'],priority:'critical',native_target:'communications-hub'},
  {id:'facebook',name:'Facebook Pages connector',category:'social',capabilities:['read_pages','read_engagement','publish_posts'],priority:'high',native_target:'social-operations'},
  {id:'instagram',name:'Instagram Business connector',category:'social',capabilities:['read_profile','read_media','publish_media','moderate_comments'],priority:'high',native_target:'social-operations'},
  {id:'whatsapp',name:'WhatsApp Business connector',category:'messaging',capabilities:['send_messages','customer_support'],priority:'high',native_target:'communications-hub'},
  {id:'shopee',name:'Shopee Seller connector',category:'commerce',capabilities:['read_products','manage_products','read_orders'],priority:'high',native_target:'commerce-engine'},
  {id:'x',name:'X connector',category:'social',capabilities:['read_profile','read_posts','publish_posts'],priority:'high',native_target:'social-operations'},
  {id:'snapchat',name:'Snapchat Business connector',category:'marketing',capabilities:['read_ad_accounts','manage_campaigns','analytics'],priority:'medium',native_target:'growth-analytics'},
  {id:'outlook',name:'Microsoft Outlook connector',category:'email',capabilities:['read_mail','send_mail'],priority:'high',native_target:'communications-hub'},
  {id:'slack',name:'Slack connector',category:'work',capabilities:['read_channels','send_messages'],priority:'high',native_target:'communications-hub'},
  {id:'discord',name:'Discord connector',category:'messaging',capabilities:['read_guilds','send_messages'],priority:'medium',native_target:'communications-hub'},
  {id:'telegram',name:'Telegram Bot connector',category:'messaging',capabilities:['send_messages'],priority:'medium',native_target:'communications-hub'},
...
const CATEGORY_CAPS={
  ...
  email:{max_cost_usd_per_action:0,requires_approval:true,external_write:'review'},
  calendar:{max_cost_usd_per_action:0,requires_approval:true,external_write:'review'},
  social:{max_cost_usd_per_action:0,requires_approval:true,external_write:'review'},
  messaging:{max_cost_usd_per_action:0,requires_approval:true,external_write:'review'},
  work:{max_cost_usd_per_action:0,requires_approval:true,external_write:'review'},
