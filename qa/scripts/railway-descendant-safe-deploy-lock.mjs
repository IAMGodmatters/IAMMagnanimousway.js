...
assert(source.includes('timeout-minutes: 60'),'Railway exact-commit workflow must allow enough time for delayed GitHub main auto-deploys and final verification.');
