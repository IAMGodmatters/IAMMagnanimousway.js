...
for(const s of ['Brand Studio','CRM + Pipelines','Sites + Funnels','Automation Studio','Unified Inbox','Appointments','Reputation','Usage Rebilling','Catalog + Packages','Client Portal Pages','Projects','Proposals + Signature Tracking','Learning Assets','Affiliate Programs','Agency Overview','Magnanimous AI','Connections','Mobile-ready Portal Pages'])if(!x.includes(s))throw Error('module '+s);
