...
for(const s of ["len(apps) == 58","catalog_count') == 58","business-ai:podcast-studio","business-ai:logo-maker"])if(!deploy.includes(s))throw Error('White Label production smoke missing '+s);
