...
for(const s of ["Client Apps catalog is empty","business-ai:podcast-studio","business-ai:logo-maker","business-ai:accounting-books","business-ai:data-studio","business-ai:open-media-library"])if(!paidSmoke.includes(s))throw Error('White Label isolated paid-depth smoke missing '+s);
