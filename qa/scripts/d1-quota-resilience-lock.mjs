...
add('production smoke proves private edge AI live inference',deploy.includes('Private Edge AI bridge live inference passed.')&&deploy.includes('/api/internal/edge-ai/run'));
