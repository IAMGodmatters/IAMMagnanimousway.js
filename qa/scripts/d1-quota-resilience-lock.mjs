...
add('production smoke proves private edge AI live inference',deploy.includes('Private Edge AI bridge live inference passed')&&deploy.includes("bridge_version') == '2026-09-25.1'")&&deploy.includes('/api/internal/edge-ai/run'));
