...
mustContain(deploy,"refresh_smoke_session\n\n          status=$(curl -sS -o /tmp/specialist-handoff.json",'Production smoke must renew its temporary session immediately before the Magnanimous chat probe.');
