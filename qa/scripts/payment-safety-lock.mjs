...
const checks=[
 ...
 ['encoded reference plan is used when metadata is absent', webhook.includes("PLANS.has(metadataPlan)?metadataPlan:(PLANS.has(referencePlan)?referencePlan:'plus')")],
