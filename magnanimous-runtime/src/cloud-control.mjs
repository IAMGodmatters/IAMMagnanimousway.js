...
export const MAGNANIMOUS_CLOUD_RESOURCE_KINDS = Object.freeze({
  workspace: { family: 'management', capacity: 'control-plane', native: true },
  project: { family: 'management', capacity: 'control-plane', native: true },
  environment: { family: 'management', capacity: 'control-plane', native: true },
  'preview-environment': { family: 'management', capacity: 'host-capacity', native: false },
  service: { family: 'paas', capacity: 'host-capacity', native: false },
  deployment: { family: 'paas', capacity: 'host-capacity', native: false },
  build: { family: 'paas', capacity: 'host-capacity', native: false },
  template: { family: 'management', capacity: 'control-plane', native: true },
  'feature-flag': { family: 'management', capacity: 'control-plane', native: true },
  secret: { family: 'security', capacity: 'native-runtime', native: true },
  domain: { family: 'networking', capacity: 'control-plane', native: true },
  certificate: { family: 'networking', capacity: 'host-capacity', native: false },
  'tcp-proxy': { family: 'networking', capacity: 'host-capacity', native: false },
  'egress-policy': { family: 'networking', capacity: 'control-plane', native: true },
  'cache-policy': { family: 'networking', capacity: 'native-runtime', native: true },
  'rate-limit-policy': { family: 'security', capacity: 'native-runtime', native: true },
  queue: { family: 'messaging', capacity: 'native-runtime', native: true },
  workflow: { family: 'messaging', capacity: 'native-runtime', native: true },
  schedule: { family: 'messaging', capacity: 'native-runtime', native: true },
  'database-gateway': { family: 'data', capacity: 'control-plane', native: true },
  'ai-gateway': { family: 'ai', capacity: 'native-runtime', native: true },
  'access-policy': { family: 'security', capacity: 'control-plane', native: true },
  'browser-session': { family: 'compute', capacity: 'host-capacity', native: false },
  'sandbox-job': { family: 'compute', capacity: 'host-capacity', native: false },
...
export const MAGNANIMOUS_CLOUD_CAPABILITIES = Object.freeze([
  ...
  { id: 'workspaces-environments', family: 'management', contract: 'workspace/project/environment hierarchy with isolated desired state', status: 'implemented-control-plane' },
  { id: 'preview-environments', family: 'management', contract: 'disposable environment desired state for PR and validation workflows', status: 'implemented-control-plane-requires-host-capacity' },
  { id: 'services-deployments-builds', family: 'paas', contract: 'service source, build, release, deployment history, health and restart desired state', status: 'implemented-control-plane-requires-host-capacity' },
  { id: 'feature-flags', family: 'management', contract: 'typed feature flag defaults and progressive delivery state', status: 'implemented-control-plane' },
  { id: 'templates', family: 'management', contract: 'reusable multi-resource application templates', status: 'implemented-control-plane' },
  { id: 'configuration-secrets', family: 'security', contract: 'scoped configuration plus encrypted runtime secret references', status: 'native-secret-vault-available' },
  { id: 'domains-certificates-tcp', family: 'networking', contract: 'domain routing, certificate lifecycle and TCP ingress desired state', status: 'implemented-control-plane-public-network-capacity-external' },
  { id: 'egress-private-network-policy', family: 'networking', contract: 'private service discovery, egress allowlists and network policy', status: 'implemented-control-plane-host-network-required' },
  { id: 'queues-workflows-schedules', family: 'messaging', contract: 'durable jobs, multi-step workflows and scheduled execution', status: 'native-runtime-available' },
  { id: 'database-gateway', family: 'data', contract: 'provider-neutral external SQL connection/pooling policy', status: 'implemented-control-plane-engine-connector-required' },
  { id: 'ai-gateway', family: 'ai', contract: 'provider-neutral model routing, fallback, budget, rate and observability policy', status: 'native-routing-contract-available' },
  { id: 'access-security-policy', family: 'security', contract: 'identity/access policy, rate controls and protected service boundaries', status: 'implemented-control-plane-plus-native-rate-limit' },
