...
export const MAGNANIMOUS_RUNTIME_SECRET_KEYS = Object.freeze([
  ...
  'MAGNANIMOUS_EDGE_AI_BRIDGE_TOKEN',
  'MAGNANIMOUS_EDGE_AI_BRIDGE_URL',
  'STRIPE_SECRET_KEY',
  ...
  'TWILIO_PHONE_NUMBER',
  'TAVUS_API_KEY',
  'MAGNANIMOUS_PREMIUM_VOICE_API_KEY',
  'MAGNANIMOUS_PREMIUM_VOICE_ID',
  'MAGNANIMOUS_PREMIUM_VOICE_MODEL',
  'MAGNANIMOUS_PREMIUM_VOICE_COMMERCIAL_OK',
  'VOIP_PROVIDER_TOKEN',
  'VOIP_WEBHOOK_SECRET',
