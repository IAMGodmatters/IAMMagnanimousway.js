...
export default function GlobalTools(){
 ...
 return <>
  ...
  `}</style>
  <style jsx global>{`
   .iam-nudge{left:calc(50% + 92px)!important;right:auto!important;bottom:14px!important;max-width:min(310px,36vw)!important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.dash .hero .mascot{min-height:300px;background:url('/magnanimous-hero.svg') center/contain no-repeat}.dash .hero .mascot img{display:none!important}@media(max-width:700px){.iam-nudge{left:16px!important;right:16px!important;bottom:124px!important;max-width:none!important;white-space:normal}.dash .hero .mascot{min-height:240px}}
  `}</style>
 </>;
}
