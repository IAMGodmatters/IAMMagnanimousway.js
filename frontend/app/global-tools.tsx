 ...
 return <>
  ...
  <div className={`iam-global-tools ${open?'open':'closed'}`}>
   ...
   <div className="iam-tools-panel" aria-hidden={!open} hidden={!open}>
    ...
    <a className="work" href="/work-engine" title="Persistent Magnanimous workflows with resumable steps"><b>↻</b><span>Work Engine</span></a>
  ...
  <style jsx>{`
   .iam-global-tools{position:fixed;right:0;top:92px;z-index:2147482900;font-family:Inter,system-ui,sans-serif;display:flex;align-items:flex-start;transition:.22s ease}.iam-tools-toggle{width:28px;height:58px;border:1px solid rgba(92,219,255,.45);border-right:0;border-radius:12px 0 0 12px;background:rgba(5,14,22,.96);color:#9feeff;font-size:22px;font-weight:900;cursor:pointer;box-shadow:0 12px 34px rgba(0,0,0,.4);backdrop-filter:blur(12px)}.iam-tools-panel{width:178px;padding:10px;display:grid;gap:7px;border:1px solid #28465b;border-right:0;border-radius:14px 0 0 14px;background:rgba(4,10,17,.97);box-shadow:0 18px 48px rgba(0,0,0,.48);transform-origin:right top;transition:.22s ease;max-height:78vh;overflow:auto}.iam-tools-panel[hidden]{display:none!important}.closed .iam-tools-panel{width:0;padding:0;border-width:0;opacity:0;overflow:hidden;pointer-events:none;transform:translateX(12px)}.iam-tools-head{padding:3px 3px 7px;display:grid;gap:2px}.iam-tools-head b{width:auto;height:auto;display:block;background:none;color:#cfefff;font-size:9px;letter-spacing:.14em}.iam-tools-head small{color:#698599;font-size:8px}.iam-tools-panel a{display:flex;align-items:center;gap:8px;border:1px solid rgba(126,224,190,.32);border-radius:11px;background:rgba(6,14,13,.92);padding:8px 9px;text-decoration:none;color:#dff8ef;font-size:9px;font-weight:900;letter-spacing:.04em;white-space:nowrap}.iam-tools-panel a>b{width:25px;height:25px;display:grid;place-items:center;border-radius:8px;background:#10241d;color:#79e6bd;font-size:12px;flex:0 0 auto}.work,.activity,.research,.inbox{border-color:rgba(88,215,245,.42)!important;background:rgba(6,20,28,.94)!important;color:#e0f9ff!important}.work>b,.activity>b,.research>b,.inbox>b{background:#10313d!important;color:#7de6f8!important}.agency,.automation{border-color:rgba(181,141,255,.48)!important;background:rgba(26,17,43,.95)!important;color:#f3ebff!important}.agency>b,.automation>b{background:#32204d!important;color:#cfb8ff!important}.automation{border-color:rgba(255,199,92,.42)!important}.automation>b{background:#42320f!important;color:#ffd476!important}.enterprise{border-color:rgba(255,198,92,.48)!important;background:rgba(35,24,7,.96)!important;color:#fff1cd!important}.enterprise>b{background:#4a3311!important;color:#ffd16e!important}.video{border-color:rgba(110,213,255,.48)!important;background:rgba(6,18,31,.95)!important;color:#e4f8ff!important}.video>b{background:#102b3a!important;color:#74ddff!important}.cx{border-color:rgba(89,239,169,.48)!important;background:rgba(5,27,20,.94)!important;color:#e4fff3!important}.cx>b{background:#103425!important;color:#62f0ae!important}.bpo{border-color:rgba(245,193,99,.42)!important;background:rgba(28,20,8,.94)!important;color:#fff2d8!important}.bpo>b{background:#3b2b10!important;color:#ffd581!important}.ops,.ownerops{border-color:rgba(86,207,255,.34)!important;background:rgba(6,16,24,.92)!important;color:#dcf6ff!important}.ops>b,.ownerops>b{background:#102634!important;color:#6edcff!important}.ownerops{border-color:rgba(255,196,78,.4)!important}.ownerops>b{background:#3d2d10!important;color:#ffd16e!important}.feedback{border-color:rgba(158,149,255,.34)!important;background:rgba(12,12,24,.92)!important;color:#ebe8ff!important}.feedback>b{background:#1d1a37!important;color:#b7afff!important}@media(max-width:680px){.iam-global-tools{top:76px}.iam-tools-panel{width:min(180px,70vw)}}
  `}</style>
  <style jsx global>{`
