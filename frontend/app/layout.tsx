...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body><a className="iam-skip-link" href="#iam-main">Skip to main content</a><a className="iam-shop-link" href="/shop" aria-label="Open God Matters Marketplace">🛍 Shop</a>{children}<PlatformChrome/><GlobalTools/><InteractionClarity/>
    <style>{`html{color-scheme:dark;scroll-behavior:smooth}body{margin:0}.iam-skip-link{position:fixed;left:16px;top:12px;z-index:2147483647;transform:translateY(-150%);padding:11px 14px;border-radius:9px;background:#eafaff;color:#051015;font:900 13px Inter,system-ui,sans-serif;text-decoration:none;box-shadow:0 8px 30px rgba(0,0,0,.4)}.iam-skip-link:focus{transform:translateY(0)}.iam-shop-link{position:fixed;right:16px;top:14px;z-index:2147483001;padding:10px 14px;border:1px solid rgba(255,211,110,.55);border-radius:999px;background:rgba(5,18,38,.94);color:#ffe39a;text-decoration:none;font:900 11px Inter,system-ui,sans-serif;letter-spacing:.04em;box-shadow:0 10px 28px rgba(0,0,0,.35);backdrop-filter:blur(10px)}.iam-shop-link:hover{border-color:#63e6ff;color:#eaffff}:where(a,button,input,textarea,select,[role="button"]):focus-visible{outline:3px solid #63e6ff!important;outline-offset:3px!important}::selection{background:#55d9f0;color:#041017}html[data-iam-public="true"] .iam-intelligence-art,html[data-iam-public="true"] .iam-command-button,html[data-iam-public="true"] .iam-command-menu,html[data-iam-public="true"] .iam-va-button,html[data-iam-public="true"] .iam-nudge,html[data-iam-public="true"] .iam-va-panel,html[data-iam-public="true"] .iam-global-tools{display:none!important}@media(max-width:760px){.iam-shop-link{right:10px;top:10px;padding:9px 12px;font-size:10px}}@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}*,*:before,*:after{animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important;scroll-behavior:auto!important}}`}</style>
    <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structuredData)}}/>
    <script dangerouslySetInnerHTML={{__html:`(function(){
      function normalize(path){var clean=(path||'/').replace(/\\/+$/,'');return clean||'/';}
      var publicPaths=['/solutions','/business-plan','/guide','/login','/signup','/owner-login','/privacy','/terms','/pricing','/reviews','/free-tools','/ai-apps','/advertise','/security','/shop'];
