...
export default function StandaloneMagnanimous(){
 ...
 async function send(e?:FormEvent,retry?:{text:string;mode:string}){
  ...
  try{
   ...
   setMessages(v=>[...v,{id:userId+1,role:'assistant',assistantName:'Magnanimous AI',content:`Connection interrupted: ${String(err?.message||err)}. Your request is preserved. Use Retry to run it again without retyping it.`}]);
