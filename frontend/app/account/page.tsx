...
export default function Account(){
 ...
 async function createRecoveryCodes(){
  ...
  try{
   ...
   setRecoveryCodes(d.codes);setRecoveryMessage('New one-time recovery codes created. Save them somewhere private before leaving this page.');
 ...
 async function confirmTotp(){
  ...
  try{
   ...
   setTotpMessage('Google Authenticator protection is enabled. Future sign-ins will require your password and current 6-digit authenticator code.');
