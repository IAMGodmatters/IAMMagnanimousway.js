...
export default function TeachMagnanimousPage(){
 ...
 return <main className="page">
  ...
  <section className="hero">
   ...
   <p>Share useful knowledge, better methods, examples, corrections, public sources, and difficult QA challenges. No account is required. Contributions are reviewed by Magnanimous automatic QA before they can be learned, and uncertain material remains held for owner oversight.</p>
  ...
  <section className="how"><article><b>1</b><h2>Choose a specialist</h2><p>Pick the Magnanimous branch that should receive the knowledge.</p></article><article><b>2</b><h2>Add useful evidence</h2><p>Provide the method, correction, source, example, or QA challenge with a clear expected outcome.</p></article><article><b>3</b><h2>Automatic QA first</h2><p>Only high-confidence, safe, reusable material can be applied automatically. Anything uncertain is held for owner review.</p></article></section>
  <PublicTeachingPanel/>
  <section className="rules"><h2>Contributor rules</h2><p>Do not submit passwords, API keys, payment or account details, private records, or personal identifiers. For prices, policies, laws, schedules, platform rules, or other information that changes, include the source, date/effective date, and relevant country, company, or platform scope.</p></section>
  <style jsx>{`
