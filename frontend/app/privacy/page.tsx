...
export default function PrivacyPage(){
  return <main style={s.page}><article style={s.card}>
    ...
    <p style={s.meta}>Effective September 11, 2026 • Version 1.1-2026-09-11</p>
    ...
    <p>Information may be processed to create and administer accounts, authenticate users, provide platform features, maintain security, prevent abuse, provide support, operate tenant workspaces and CRM functions, maintain records, improve reliability, personalize private workspace behavior, and manage customer or lead relationships arising from registration and use of the platform.</p>

    <h2 style={s.h2}>Magnanimous private learning</h2>
    <p>Magnanimous may use information from your own workspace—such as examples you explicitly approve, saved knowledge, remembered preferences, and technical success/quality signals from platform workflows—to improve routing and reusable lessons for that same tenant and user. This continuous-learning layer is isolated by tenant and user. One customer's private workspace information is not promoted into another customer's private learning profile, and this platform feature does not itself retrain a public foundation model. Training examples are also screened to discourage storage of passwords, API keys, access tokens, and private keys. Where the training controls are available, continuous learning can be paused from the Magnanimous Training Center.</p>
    ...
    <p>Account, private learning, and operational records may be retained while an account is active and for a reasonable period afterward when needed for the service, security, legal obligations, dispute handling, fraud prevention, backup recovery, or legitimate business administration. Information should not be kept longer than reasonably necessary for the stated purpose.</p>
