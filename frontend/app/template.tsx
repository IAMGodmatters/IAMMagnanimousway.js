...
const publicPaths=new Set(['/','/teach','/shop','/login','/signup','/owner-login','/forgot-password','/solutions','/guide','/launchplan','/business-plan','/security','/free-tools','/ai-apps','/pricing','/reviews','/privacy','/terms','/advertise','/white-label','/movie']);
