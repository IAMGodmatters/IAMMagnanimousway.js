...
SUBST_VARS='${ASTERISK_ARI_USER} ${ASTERISK_ARI_PASSWORD} ${ASTERISK_SIP_PORT} ${MAGNANIMOUS_SIP_DOMAIN} ${MAGNANIMOUS_AI_EXTENSION} ${MAGNANIMOUS_AI_PASSWORD} ${MAGNANIMOUS_ADMIN_EXTENSION} ${MAGNANIMOUS_ADMIN_PASSWORD} ${CARRIER_SIP_ENDPOINT} ${CARRIER_SIP_HOST} ${CARRIER_SIP_PORT} ${CARRIER_SIP_USERNAME} ${CARRIER_SIP_PASSWORD} ${CARRIER_SIP_FROM_DOMAIN} ${CARRIER_SIP_SECONDARY_ENDPOINT} ${CARRIER_SIP_SECONDARY_HOST} ${CARRIER_SIP_SECONDARY_PORT} ${CARRIER_SIP_SECONDARY_USERNAME} ${CARRIER_SIP_SECONDARY_PASSWORD} ${CARRIER_SIP_SECONDARY_FROM_DOMAIN} ${TELECOM_PUBLIC_IP}'
