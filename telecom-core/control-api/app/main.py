...
async def webrtc(container: ApplicationContainer = Depends(get_container)) -> dict[str, Any]:
    ...
    return {
        ...
        "relay_local_media": settings.webrtc_relay_local_media,
        "turn_relay_configured": bool(settings.webrtc_turn_urls),
        "ice_transport_policy": "relay" if settings.webrtc_turn_force_relay else "all",
